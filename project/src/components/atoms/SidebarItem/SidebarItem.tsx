        ...
        <>
            {
                isActive ?
                    <div className="cursor-pointer" onClick={onClick}>
                        {isOpen ? <img src="/images/bg.svg" alt="" className="absolute -right-[0.9px] z-99 -translate-y-[32%]" /> : <img src="/images/bg-small.svg" alt="" className="absolute -right-[0.9px] z-99 -translate-y-[32%]" /> } 
